...
<section class="py-5">
    <div class="container px-4 px-lg-5 my-5">
        <div class="row gx-4 gx-lg-5 align-items-center">
            <div class="col-md-6"><img src="https://image.wconcept.co.kr/productimg/image/img0/69/301739069_GG15463.jpg" alt="..." /></div>
            <div class="col-md-6">
                <div class="small mb-1"></div>
                <h1 class="display-5 fw-bolder" style="float: right">포르테 포르테 리미티드 컬렉션</h1>
                <div class="fs-5 mb-5">
                </div>
