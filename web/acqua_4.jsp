...
<section class="py-5">
    <div class="container px-4 px-lg-5 my-5">
        <div class="row gx-4 gx-lg-5 align-items-center">
            <div class="col-md-6"><img src="https://i1.wp.com/www.acquadiparma.kr/wp-content/uploads/2020/03/ADP22002-100ML.master.1.H1-1.jpg?fit=490%2C490&ssl=1" alt="..." /></div>
            <div class="col-md-6">
                <div class="small mb-1"></div>
                <h1 class="display-5 fw-bolder" style="float: rigt">콜로니아 에센자</h1>
                <div class="fs-5 mb-5">
                </div>
