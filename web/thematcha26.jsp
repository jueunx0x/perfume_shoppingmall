...
<section class="py-5">
    <div class="container px-4 px-lg-5 my-5">
        <div class="row gx-4 gx-lg-5 align-items-center">
            <div class="col-md-6" ><img style="width: 500px;height: 500px;" src="https://lelabo.ips.photos/lelabo-java/images/skus/J34301R000__Product_01--IMG_1200--THMATCHA26-473047514.jpg" alt="..." /></div>
            <div class="col-md-6">
                <div class="small mb-1"></div>
                <h1 class="display-5 fw-bolder" style="float: rigt">The Matcha 13</h1>
                <div class="fs-5 mb-5">
                </div>
                <div class="elementor-widget-container">
                    ...
                    <div class="size_button">
                        ...
                        <h2>사이즈 선택</h2>
                        <button id="btn2" class="on">50ML</button>
