...
<section class="py-5">
    <div class="container px-4 px-lg-5 my-5">
        <div class="row gx-4 gx-lg-5 align-items-center">
            <div class="col-md-6" ><img style="width: 500px;height: 500px;" src="https://media-live.byredo.com/__live__/media/klevu_images/720X806/m/o/mob_baldafrique_edp-50_c_1.jpg" alt="..." /></div>
            <div class="col-md-6">
                <div class="small mb-1"></div>
                <h1 class="display-5 fw-bolder" style="float: rigt">Bal d'Afrique</h1>
                <div class="fs-5 mb-5">
                </div>
